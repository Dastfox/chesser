...
class PlayerCreation:
    ...
    def __init__(self, players_list=[]) -> None:
        ...
        Args:
        players_list (list[Player], optional):
        A list of player objects. Defaults to an empty list.
        """
    ...
    def create_new(self):
        ...
        Prompts the user for input for the player's first name,
        last name, birthdate, gender, and rank.
        Validates the input and creates a new player
        object with the provided information.
        Appends the new player object to the players list.
        ...
        player_list_lenth = len(
            Player.deserialize_players(Database.read_db("players"))
        )
